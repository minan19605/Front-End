  ...
  return (
    ...
    <header className="header">
        ...
        <div className="search-bar-container">
            <input type="text" id="search-input" name="searchQuery" placeholder="Search by Movie Title" className="search-bar-input" value={movieTitle} onChange={(event) => inputMovieTitle(event.target.value)}/>
            <div className="search-icon" onClick={() => searchMovie()}>
            <FontAwesomeIcon icon={faMagnifyingGlass}/>
            </div>
        </div>
        <div className="slider-container">
            <input type="range" min="1930" max="2025" value={year} className="slider" id="myRange" onChange={(event) => inputYear(event.target.value) }/>
